...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Champion rell = new Champion("Rell", "The Iron Maiden", "Support", "Break The Mold", "Shattering Strike", "Crash Down/Mount Up", "Attract and Repel", "Magnet Storm", 0, 1, 0.2, 3, 4);
