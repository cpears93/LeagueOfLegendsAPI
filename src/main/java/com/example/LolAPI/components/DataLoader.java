...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Champion rell = new Champion("Rell", "The Iron Maiden", "Support", "Break The Mold", "Shattering Strike", "Crash Down/Mount Up", "Attract and Repel", "Magnet Storm", 350, 35, 0.55, 55, 540);
        ...
        Champion seraphine = new Champion("Seraphine", "The Starry-Eyed Songstress", "Mage", "Echo", "High Note", "Surround Sound", "Beat Drop", "Encore", 440, 10, 0.669, 50, 500);
